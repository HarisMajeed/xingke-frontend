...
🚫 Please do not mention Binance, Bybit, OKX, Huobi, Crypto, USDT, Bitcoin, P2P or any similar words when making a payment. The bank may block your account.

🚫 Please do not make any payments from joint accounts unless all parties wish to be verified as well. 

🚫 Please do not make any payments from Business/Trust/Retirement accounts.

🚫 Please note that some banks take up to 24-72 hours to release the funds to us, we will not be able to release the trade until the funds have cleared. 
...
🚫 We may require additional information as per our AML/KYC policy found HERE.`,
  ...
  zh: {
    ...
    title: "条款与条件",
    description: `感谢您与 行科发展 开立交易。

我们希望确保您的资金安全，因为涉及加密货币的诈骗行为，通过勾选下面的选项，您同意您是为自己购买资金，而不是为第三方购买。

一些诈骗示例包括：

* 投资 - 高回报投资，公司随机致电要求投资，您需要支付更多资金才能获得利润。请务必谷歌您计划转账的公司！

* 工作机会 - 真正的工作不会要求您发送加密货币

* 恋爱 - Tinder 或其他约会网站有人向您索要资金

* 税务/账单问题 - 税务局或其他大公司要求您支付未知账单

* 签证问题 - 移民局威胁您除非支付加密货币，否则将被驱逐

* 买家悔恨 - 在购买加密货币前，请务必做好研究。不要购买您无法承受损失的资产，因为总有损失风险。

🚫 🚫 🚫 🚫 一旦发送加密货币，将无法撤回。 🚫 🚫 🚫 🚫

🚫 请勿在付款时提及 Binance、Bybit、OKX、Huobi、Crypto、USDT、Bitcoin、P2P 或类似词汇。银行可能会封锁您的账户。

🚫 请勿使用联名账户付款，除非所有相关人员也希望进行验证。

🚫 请勿使用企业/信托/退休账户付款。

🚫 请注意，有些银行可能需要 24-72 小时才能释放资金，我们将无法在资金到账前释放交易。
...
🚫 我们可能会根据 AML/KYC 政策要求提供额外信息。`,
  ...
  es: {
    ...
    headerTile: "Colección de Monedas",
    title: "Términos y Condiciones",
    description: `Gracias por abrir una operación con Xingke Development. 

Queremos garantizar su seguridad ya que existen estafas relacionadas con la compra de criptomonedas. Al marcar a continuación, acepta que está comprando los fondos para usted mismo y no para un tercero.

Algunos ejemplos de estafas incluyen:

* Inversiones - Altos rendimientos, llamadas de empresas aleatorias para invertir, necesita pagar más dinero para obtener su ganancia. ¡Siempre busque en Google la empresa a la que planea enviar dinero!

* Ofertas de trabajo - Un trabajo real nunca le pedirá enviar criptomonedas
...
* Problemas de visados - Inmigración amenaza con deportación a menos que pague en criptomonedas
...
🚫 🚫 🚫 🚫 Una vez que envíe su criptomoneda, no hay forma de revertirla. 🚫 🚫 🚫 🚫

🚫 No mencione Binance, Bybit, OKX, Huobi, Crypto, USDT, Bitcoin, P2P o palabras similares al realizar un pago. El banco puede bloquear su cuenta.

🚫 No realice pagos desde cuentas conjuntas a menos que todas las partes también deseen verificarse.

🚫 No realice pagos desde cuentas empresariales/fideicomisos/jubilación.

🚫 Tenga en cuenta que algunos bancos tardan hasta 24-72 horas en liberar los fondos, no podremos liberar la operación hasta que los fondos se hayan acreditado.
...
🚫 Podemos requerir información adicional según nuestra política AML/KYC.`,
  ...
  pt: {
    ...
    headerTile: "Coleção de Moedas",
    title: "Termos & Condições",
    description: `Obrigado por abrir uma negociação com Xingke Development. 

Queremos garantir sua segurança, pois existem golpes relacionados à compra de criptomoedas. Ao marcar abaixo, você concorda que está comprando os fundos para si mesmo e não para terceiros.

Alguns exemplos de golpes incluem:

* Investimentos - Altos retornos, chamadas de empresas aleatórias para investir, você precisa pagar mais para obter seu lucro. Sempre pesquise no Google a empresa para a qual pretende enviar dinheiro!

* Ofertas de emprego - Um emprego real nunca pedirá que você envie criptomoedas

* Romance - alguém no Tinder ou sites de namoro pedindo dinheiro

* Problemas de impostos/faturas - O escritório de impostos ou outras grandes empresas pedem para pagar uma fatura desconhecida

* Questões de vistos - A imigração ameaça deportação, a menos que você pague em criptomoeda

* Arrependimento do comprador - Pesquise sempre as moedas/token de criptomoedas antes de comprar. Nunca compre o que não pode perder.

🚫 🚫 🚫 🚫 Uma vez que você envie sua criptomoeda, não há como revertê-la. 🚫 🚫 🚫 🚫

🚫 Não mencione Binance, Bybit, OKX, Huobi, Crypto, USDT, Bitcoin, P2P ou palavras semelhantes ao fazer o pagamento. O banco pode bloquear sua conta.

🚫 Não faça pagamentos de contas conjuntas, a menos que todas as partes também desejem ser verificadas.

🚫 Não faça pagamentos de contas empresariais/fiduciárias/aposentadoria.

🚫 Observe que alguns bancos levam até 24-72 horas para liberar os fundos, não poderemos liberar a negociação até que os fundos sejam compensados.
...
🚫 Podemos exigir informações adicionais conforme nossa política AML/KYC.`,
    ...
    fields: {
      ...
      checkbox: "Aceito os termos & condições e a Política de Privacidade",
      submit: "Enviar",
    },
  },
};
